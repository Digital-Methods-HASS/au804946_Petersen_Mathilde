...
The two graphs show opposite long-term trends. The duration of Danish monarchs’ reigns appears to increase over time, indicating that monarchs tend to rule for longer periods in more recent history. In contrast, homicide rates across European regions show a clear decline over time. This suggests a negative relationship between the two patterns: as societies develop over time, violence (measured by homicide rates) decreases, while political stability (reflected in longer reigns) increases.
...
Together these trends point in the same direction: declining violence and increasing stability. This suggests that modern societies are more orderly and predictable than in the past, which can be seen as a form of increased “civilization.”
However, these measures capture only certain aspects of civilization - mainly violence and political stability and do not account for other dimensions such as inequality, war, or structural violence. Therefore, while the data support the idea that we are more civilized in some aspects, the conclusion is not absolute.